...
<nav class="navbar navbar-expand-lg navbar-light bg-info-color-dark ">
  <a class="navbar-brand" href="#">Online Clerance</a>
    ...
    <ul class="navbar-nav ml-auto mr-10">
      <?php
       ...
       if($role == "student"){?>
          ...
          <li class="nav-item <?php if($active=='viwestatus') echo "active";?>">
            <a class="nav-link" href="viwestatus">SeeStatus</a>
            
          </li>
          <li class="nav-item <?php if($active=='progress') echo "active";?>">
       ...
       <?php }
        ...
        <li class="nav-item <?php if($active=='home') echo "active";?>">
            ...
            <li class="nav-item <?php if($active=='viewRequest') echo "active";?>">
              <a class="nav-link" href="requrment.html">View Request</a>
            </li>
       <?php }?>
       <li class="nav-item">
